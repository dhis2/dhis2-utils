...
def main() -> None:
    ...
    input_columns = json.loads(os.getenv('PACKAGES_EXPORT_INPUT_COLUMNS', '["DHIS2 code for packaging", "Source instance", "Script parameter", "Component name", "DHIS2 versions to export from"]'))
