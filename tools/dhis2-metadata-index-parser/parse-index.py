...
def get_input_args() -> argparse.Namespace:
    ...
    parser.add_argument('--toggle-column', type=str, default='Extraction Enabled', help='Packages toggle column.')
    parser.add_argument('--readiness-column', type=str, default='Ready for Export', help='Packages readiness column.')
    parser.add_argument('--input-columns', type=str, default='["Extraction code", "Source instance", "Script parameter", "Component name", "DHIS2 versions to export from", "Health area", "Health area prefix"]', help='Packages input columns.')
