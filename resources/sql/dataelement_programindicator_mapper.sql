...
cc.name as cc_name, cocc.name as coc_name, cocc.code as coc_code,
...
from dataset ds 
inner join datasetelement dsde on ds.datasetid=dsde.datasetid
inner join dataelement de on de.dataelementid=dsde.dataelementid
inner join categorycombo cc on cc.categorycomboid=de.categorycomboid
inner join categorycombos_optioncombos coc on coc.categorycomboid=cc.categorycomboid
inner join categoryoptioncombo cocc on cocc.categoryoptioncomboid=coc.categoryoptioncomboid
